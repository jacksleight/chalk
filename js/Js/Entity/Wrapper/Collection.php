...
class Collection extends \Js\Entity\Wrapper implements \Iterator, \Countable
{
	protected $_md;
	protected $_iterator;
	...
	public function __get($name)
	{
		...
		if ($value instanceof \Js\Entity) {
			return new \Js\Entity\Wrapper\Entity($value, $this->_allowed, $this, $name);
		} else {
			return $value;
		}
	}
	...
	{
		return new \Js\Entity\Wrapper\Entity($this->_object->current(), $this->_allowed, $this, $this->key());
	}
