...
class Count extends \Js\Validator
{
	const LOW	= 'validator_count_low';
	const HIGH	= 'validator_count_high';
	...
	public function isValid($value)
	{
		...
		if (isset($this->_min) && count($value) < $this->_min) {
			$this->_addError(self::LOW);
			return false;
		}
		if (isset($this->_max) && count($value) > $this->_max) {
