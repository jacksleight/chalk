...
$types = [
	...
	'coast_array'     => 'array',
	'coast_url'       => 'input_url',
	'chalk_entity'    => 'input_chalk-ref',
	'chalk_ref'       => 'input_chalk-ref',
	'chalk_ref_array' => 'array_input_chalk-ref',
	'manyToOne'       => isset($values) ? 'select' : 'input_chalk-entity',
	'manyToMany'      => isset($values) ? 'input_checkboxes' : 'array_input_chalk-entity',
];
$type = !isset($type)
	? (isset($types[$md['type']])
		? $types[$md['type']]
